...
<script src="{{('admin/lib/jquery-pjax/jquery.pjax.js')}}"></script>
<script src="{{('admin/lib/bootstrap-sass-official/assets/javascripts/bootstrap.js')}}"></script>
<script src="{{('admin/lib/widgster/widgster.js')}}"></script>
<script src="{{('admin/lib/underscore/underscore.js')}}"></script>
